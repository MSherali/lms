...
<div class="panel">
    <div class="panel-heading">
        <form class="col-md-11" action="<?=Url::to(['articles/essies'])?>" method="get">
            <input type="hidden" name="id" value="<?=$id?>">
            <div class="row">
                <div class="col-md-4">
                    <?=Html::dropDownList('essy',$essy, $essies,['class'=>'form-control' ])?>
                </div>
                <div class="col-md-4">
        ...
        <?php foreach ($data as $model): ?>
            <div class="form-group">
                <h4>
                    ...
                    <?= Html::a(Yii::t('app', 'btn-rate'), ['articles/essy-rate','id'=>$model->id,'article'=>$id], ['class' => 'update-modal pull-right']) ?>
                </h4>
                <div class="well">
                    <p><?=$model->reply?></p>
